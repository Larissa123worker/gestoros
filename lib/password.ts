/** Hash de senha com salt (SHA-256). Formato armazenado: `salt$hash`. */
...
async function sha256Hex(input: string): Promise<string> {
  ...
  // Fallback síncrono mínimo (ambiente sem SubtleCrypto)
  return legacySha256Hex(input);
}

/** SHA-256 puro (fallback). */
function legacySha256Hex(message: string): string {
...
const PEPPER = "gestor-os-profissional-v1";
...
// evita warning de unused em alguns bundlers
void fromHex;
